...
//                Schema::dropIfExists('sculpture');
                ...
                $painting->artist = 'qwerty';
                $painting->year = 2014;
                $painting->save();
		$theLandmarks = array("Zoetermeer", "Amsterdam", "Den Haag", "Voorburg", "Gouda");
		return View::make('hello', array('theLocation' => 'Zoetermeer', 'theWeather' => 'sunny', 'theLandmarks' => $theLandmarks));
	}
